  ...
  <div class="content-wrapper bg-white">
      <div class="content-header">
          <div class="row mb-2">
              <div class="col-sm-12">
                <ol class="breadcrumb">
                     <li class="breadcrumb-item"><a href="<?= base_url('produk/index'); ?>">Produk</a></li>
        ...
        <section class="content">
            <div class="row">
                <div class="col-12">
                    <?php 
                    if($this->session->flashdata('msg-produk'))
                    {
                        echo pesan_sukses($this->session->flashdata('msg-produk'));
                    }elseif($this->session->flashdata('msg-gagal-produk'))
                    {
                        echo pesan_gagal($this->session->flashdata('msg-gagal-produk'));
                    }
                    ?>
                    <div class="card border border-secondary">
                        ...
                        <div class="card-body">
                            <div class="table table-responsive">
                                <table class="table table-bordered table-striped table-sm" id="table-produk">
