<script>
    ...
    { 
        table1 = $("#table-produk").DataTable({
            ...
            ajax: {
                url: base_url + "produk/get_data_produk",
                type: "POST",
            },
    ...
    { 
        table2 = $("#table-produk-bisa-dijual").DataTable({
            ...
            ajax: {
                url: base_url + "produk/get_data_produk_bisa_dijual",
                type: "POST",
            },
    ...
    function save_produk()
    {
        ...
        if(save_method == 'add')
        {
            url = base_url + "produk/tambah-produk";
            pesan_gagal = 'Data Gagal Disimpan! ';
        }else
        {
            url = base_url + "produk/edit-produk";
    ...
    function edit_produk(id_produk)
    {
        ...
        $.ajax({
            url : base_url + "produk/get_produk_by_id/"+id_produk,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
    ...
    function delete_produk(id_produk)
    {
        swal({
            ...
            {
                $.ajax({
                    url : base_url + "produk/hapus-produk/"+id_produk,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
